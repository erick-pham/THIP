    ...
    <form id="form1" runat="server">
        <div class="wrapper">
            ...
            <div class="wrap-content">
                        ...
                        <div class="col-md-8">
                            <div class="cost-wrap">
                                ...
                                <div id="Overallcost">
                                    ...
                                    <h4 style="font-weight: bold;">Chi phí: Tháng <%=cost_month%> - <%=cost_year %></h4>
                                    <p>Phí quản lý định kỳ: <%=dinhky %> vnđ</p>
                                    <p>Phí phát sinh: <%=phatsinh %> vnđ</p>
                                    <p>Tổng thanh toán: <%=tongtien %> vnđ</p>
                                    <p>
                                        Trạng thái: <% if (trangthai.Equals("ok")) Response.Write("<span style=\"color: red\">Đã thanh toán</span>");
                                                       else Response.Write("<span style=\"color: red\">Chưa thanh toán</span>");%>
                                    </p>
                                    ...
                                    <small id="lbPower" style="cursor: pointer;">Điện</small><br />
                                    <small id="lbWater" style="cursor: pointer;">Nước cấp</small><br />
                                    <small id="lbWaste" style="cursor: pointer;">Nước thải</small><br />
                                    <small id="lbCod" style="cursor: pointer;">Chỉ số COD</small><br />
                                    <div class="chart-wrap" id="chartblock">
                                    </div>
                                </div>
                                <hr />
                                <div class="row">
                ...
                <%-- end div wrap content --%>
                <div class="row">
                    <div class="feedback-box" id="fback-box">
                        <div class="panel-fback" style="cursor: pointer;" id="chatPopup">
                            <span>Gửi phản hồi<i class="glyphicon glyphicon-chevron-up" id="iconPopup" style="float: right; left: 5px;"></i></span>
                        </div>
